...
<html>
    ...
    Functions::DostupnostStraniceRegistrirani("mojiOglasi.php");
    ?>
    <body>
        ...
        <section id="natjecanja" class="sectionA sirina">
            <h1 class="naslov paddingTop">Moji zahtjevi za kreiranje oglasa</h1>
           
            <div class="kartice_box">
                <?php 
                $idKorisnika = $_SESSION["id"];
                Functions::IspisOglasaPoKorisniku($idKorisnika); ?>
            </div>
            
            <h1 class="naslov paddingTop">Moji odobreni oglasi</h1>
           
            <div class="kartice_box">
                <?php 
                Functions::IspisOglasaPoKorisniku($idKorisnika, true); ?>
            </div>
            
            <?php
            $upit = "SELECT * FROM `Oglasi` WHERE `Korisnici_ID` = $idKorisnika";
            echo Functions::IspisTablice($upit, "Oglasi", "Statistika klikova po oglasu", 2, 4, 5, 8);
            ?>
        </section>
